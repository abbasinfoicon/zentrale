! function(e, t) {
    ...
    function M(e, t, i) {
        var n = "string" == typeof t,
            ...
            o = e.replace(j, ""),
            r = O[o];
        return r && (o = r), z.has(o) || (o = e), [n, s, o]
    }
    ...
    function $(e, t, i, n, s) {
        if ("string" == typeof t && e) {
            ...
            if (u) u.oneOff = u.oneOff && s;
                ...
                var h = I(a, t.replace(C, "")),
                    p = r ? (g = e, v = i, y = n, function e(t) {
                        for (var i = g.querySelectorAll(v), n = t.target; n && n !== this; n = n.parentNode)
                            for (var s = i.length; s--;)
                                if (i[s] === n) return t.delegateTarget = n, e.oneOff && B.off(g, t.type, y), y.apply(n, [t]);
                        return null
                    }) : (f = e, m = i, function e(t) {
                        return t.delegateTarget = f, e.oneOff && B.off(f, t.type, m), m.apply(f, [t])
                    });
                    ...
                    if (void 0 === s) {
                        c && Object.keys(d).forEach(function(e) {
                            ...
                            i = a, n = d, s = e, o = l.slice(1), r = n[s] || {}, Object.keys(r).forEach(function(e) {
                                if (e.includes(o)) {
                                    var t = r[e];
                                    R(i, n, s, t.originalHandler, t.delegationSelector)
                                }
                            })
                        });
                        var u = d[o] || {};
                        Object.keys(u).forEach(function(e) {
                            ...
                            if (!r || l.includes(t)) {
                                var i = u[e];
                                R(a, d, o, i.originalHandler, i.delegationSelector)
                            }
                        })
                    } else {
                        if (!d || !d[o]) return;
    ...
    B.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', H.handleDismiss(new H)), e(function() {
        var e = x();
        if (e) {
            var t = e.fn[F];
    ...
    var U = {
            ...
            getDataAttributes: function(i) {
                ...
                return Object.keys(i.dataset).filter(function(e) {
                    ...
                    var t = e.replace(/^bs/, "");
                    t = t.charAt(0).toLowerCase() + t.slice(1, t.length), n[t] = W(i.dataset[e])
                }), n
            },
            getDataAttribute: function(e, t) {
                return W(e.getAttribute("data-bs-" + G(t)))
            },
            offset: function(e) {
        ...
        J = function(n) {
            function o(e, t) {
                var i;
                return (i = n.call(this, e) || this)._items = null, i._interval = null, i._activeElement = null, i._isPaused = !1, i._isSliding = !1, i.touchTimeout = null, i.touchStartX = 0, i.touchDeltaX = 0, i._config = i._getConfig(t), i._indicatorsElement = Y.findOne(".carousel-indicators", i._element), i._touchSupported = "ontouchstart" in document.documentElement || 0 < navigator.maxTouchPoints, i._pointerEvent = Boolean(window.PointerEvent), i._addEventListeners(), i
            }
            c(o, n);
            var e = o.prototype;
            return e.next = function() {
                ...
                e || (this._isPaused = !0), Y.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (d(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, e.cycle = function(e) {
                ...
                n.prototype.dispose.call(this), B.off(this._element, ".bs.carousel"), this._items = null, this._config = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, e._getConfig = function(e) {
                return e = a({}, Q, e), y(X, e, K), e
                ...
                if (s = "next" === e ? (i = "carousel-item-start", n = "carousel-item-next", "left") : (i = "carousel-item-end", n = "carousel-item-prev", "right"), l && l.classList.contains("active")) this._isSliding = !1;
                    ...
                    if (this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l), this._activeElement = l, this._element.classList.contains("slide")) {
                        l.classList.add(n), w(l), r.classList.add(i), l.classList.add(i);
                        var u = g(r);
                ...
                var i = S(e, "bs.carousel"),
                    n = a({}, Q, U.getDataAttributes(e));
                ...
                if (t && t.classList.contains("carousel")) {
                    var i = a({}, U.getDataAttributes(t), U.getDataAttributes(this)),
                        n = this.getAttribute("data-bs-slide-to");
                    n && (i.interval = !1), o.carouselInterface(t, i), n && S(t, "bs.carousel").to(n), e.preventDefault()
                }
            }, r(o, null, [{
                key: "Default",
                get: function() {
    ...
    B.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", J.dataApiClickHandler), B.on(window, "load.bs.carousel.data-api", function() {
        for (var e = Y.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++) J.carouselInterface(e[t], S(e[t], "bs.carousel"))
    }), e(function() {
        var e = x();
        if (e) {
            var t = e.fn[X];
            e.fn[X] = J.jQueryInterface, e.fn[X].Constructor = J, e.fn[X].noConflict = function() {
                return e.fn[X] = t, J.jQueryInterface
            }
        }
    });
    var Z = "collapse",
        ...
        ie = function(d) {
            function l(t, e) {
                var i;
                (i = d.call(this, t) || this)._isTransitioning = !1, i._config = i._getConfig(e), i._triggerArray = Y.find('[data-bs-toggle="collapse"][href="#' + t.id + '"],[data-bs-toggle="collapse"][data-bs-target="#' + t.id + '"]');
                for (var n = Y.find('[data-bs-toggle="collapse"]'), s = 0, o = n.length; s < o; s++) {
                    var r = n[s],
                        a = u(r),
                        l = Y.find(a).filter(function(e) {
                            return e === t
                        });
            ...
            return e.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    ...
                    if (!B.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        e && e.forEach(function(e) {
                            n !== e && l.collapseInterface(e, "hide"), i || T(e, "bs.collapse", null)
                        });
                        ...
                        B.one(this._element, "transitionend", function() {
                            t._element.classList.remove("collapsing"), t._element.classList.add("collapse", "show"), t._element.style[o] = "", t.setTransitioning(!1), B.trigger(t._element, "shown.bs.collapse")
                        }), v(this._element, a), this._element.style[o] = this._element[r] + "px"
                    }
                }
            }, e.hide = function() {
                var e = this;
                if (!this._isTransitioning && this._element.classList.contains("show") && !B.trigger(this._element, "hide.bs.collapse").defaultPrevented) {
                    ...
                    this._element.style[t] = this._element.getBoundingClientRect()[t] + "px", w(this._element), this._element.classList.add("collapsing"), this._element.classList.remove("collapse", "show");
                ...
                return (e = a({}, ee, e)).toggle = Boolean(e.toggle), y(Z, e, te), e
                ...
                return Y.find(t, e).forEach(function(e) {
                    var t = h(e);
                ...
                var i = S(e, "bs.collapse"),
                    n = a({}, ee, U.getDataAttributes(e), "object" == typeof t && t ? t : {});
    ...
    B.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', function(e) {
        ...
        var n = U.getDataAttributes(this),
            t = u(this);
        Y.find(t).forEach(function(e) {
            var t, i = S(e, "bs.collapse");
            t = i ? (null === i._parent && "string" == typeof n.parent && (i._config.parent = n.parent, i._parent = i._getParent()), "toggle") : n, ie.collapseInterface(e, t)
        })
    }), e(function() {
        var e = x();
        if (e) {
            var t = e.fn[Z];
            e.fn[Z] = ie.jQueryInterface, e.fn[Z].Constructor = ie, e.fn[Z].noConflict = function() {
                return e.fn[Z] = t, ie.jQueryInterface
            }
        }
    });
    var ne = "dropdown",
        se = new RegExp("ArrowUp|ArrowDown|Escape"),
        oe = t ? "top-end" : "top-start",
        re = t ? "top-start" : "top-end",
        ae = t ? "bottom-end" : "bottom-start",
        le = t ? "bottom-start" : "bottom-end",
        de = t ? "left-start" : "right-start",
        ce = t ? "right-start" : "left-start",
        ue = {
            offset: 0,
            flip: !0,
        ...
        pe = function(n) {
            ...
            return e.toggle = function() {
                ...
                if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                    ...
                    if (!B.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                        if (!this._inNavbar) {
                            ...
                            var i = this._element;
                            "parent" === this._config.reference ? i = e : p(this._config.reference) && (i = this._config.reference, void 0 !== this._config.reference.jquery && (i = this._config.reference[0])), this._popper = f.createPopper(i, this._menu, this._getPopperConfig())
                        }
                        var n;
                ...
                n.prototype.dispose.call(this), B.off(this._element, ".bs.dropdown"), this._menu = null, this._popper && (this._popper.destroy(), this._popper = null)
            }, e.update = function() {
                ...
                return e = a({}, this.constructor.Default, U.getDataAttributes(this._element), e), y(ne, e, this.constructor.DefaultType), e
                ...
                if (e.classList.contains("dropstart")) return ce;
                var t = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
                return e.classList.contains("dropup") ? t ? re : oe : t ? le : ae
                ...
                if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                    for (var t = Y.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                        ...
                        if (e && "click" === e.type && (r.clickEvent = e), o) {
                            var a, l = o._menu;
                            if (t[i].classList.contains("show") && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && "Tab" === e.key) && l.contains(e.target) || B.trigger(s, "hide.bs.dropdown", r).defaultPrevented)) "ontouchstart" in document.documentElement && (a = []).concat.apply(a, document.body.children).forEach(function(e) {
                                return B.off(e, "mouseover", null, function() {})
                            }), t[i].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), l.classList.remove("show"), t[i].classList.remove("show"), B.trigger(s, "hidden.bs.dropdown", r)
                        }
                    }
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !se.test(e.key)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                    ...
                    if ("Escape" === e.key) return (this.matches('[data-bs-toggle="dropdown"]') ? this : Y.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(), void d.clearMenus();
                    if (i && "Space" !== e.key) {
                        var n = Y.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(b);
                        if (n.length) {
    ...
    B.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', pe.dataApiKeydownHandler), B.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", pe.dataApiKeydownHandler), B.on(document, "click.bs.dropdown.data-api", pe.clearMenus), B.on(document, "keyup.bs.dropdown.data-api", pe.clearMenus), B.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', function(e) {
        e.preventDefault(), e.stopPropagation(), pe.dropdownInterface(this, "toggle")
        ...
        if (e) {
            var t = e.fn[ne];
            e.fn[ne] = pe.jQueryInterface, e.fn[ne].Constructor = pe, e.fn[ne].noConflict = function() {
                return e.fn[ne] = t, pe.jQueryInterface
            }
        }
    });
    var fe = {
        ...
        ge = function(n) {
            function s(e, t) {
                var i;
                return (i = n.call(this, e) || this)._config = i._getConfig(t), i._dialog = Y.findOne(".modal-dialog", e), i._backdrop = null, i._isShown = !1, i._isBodyOverflowing = !1, i._ignoreBackdropClick = !1, i._isTransitioning = !1, i._scrollbarWidth = 0, i
            }
            c(s, n);
            var e = s.prototype;
            return e.toggle = function(e) {
                ...
                }), n.prototype.dispose.call(this), B.off(document, "focusin.bs.modal"), this._config = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, e.handleUpdate = function() {
                this._adjustDialog()
            }, e._getConfig = function(e) {
                return e = a({}, fe, e), y("modal", e, me), e
                ...
                if (i) {
                    ...
                    B.one(this._dialog, "transitionend", s), v(this._dialog, o)
                } else s()
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), document.body.appendChild(this._backdrop), B.on(this._element, "click.dismiss.bs.modal", function(e) {
                        ...
                        }), i && w(this._backdrop), this._backdrop.classList.add("show"), !i) return void e();
                    var n = g(this._backdrop);
                    B.one(this._backdrop, "transitionend", e), v(this._backdrop, n)
                    ...
                    if (this._element.classList.contains("fade")) {
                        var o = g(this._backdrop);
                        B.one(this._backdrop, "transitionend", s), v(this._backdrop, o)
                    } else s()
                } else e()
                ...
                if (!B.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented) {
                    ...
                    }), v(this._element, i), this._element.focus()
                }
                ...
                if (this._isBodyOverflowing) {
                    Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(function(e) {
                        ...
                        U.setDataAttribute(e, "padding-right", t), e.style.paddingRight = Number.parseFloat(i) + n._scrollbarWidth + "px"
                    }), Y.find(".sticky-top").forEach(function(e) {
                        var t = e.style.marginRight,
                            i = window.getComputedStyle(e)["margin-right"];
                        U.setDataAttribute(e, "margin-right", t), e.style.marginRight = Number.parseFloat(i) - n._scrollbarWidth + "px"
                    });
                    var e = document.body.style.paddingRight,
                        t = window.getComputedStyle(document.body)["padding-right"];
                    U.setDataAttribute(document.body, "padding-right", e), document.body.style.paddingRight = Number.parseFloat(t) + this._scrollbarWidth + "px"
                }
                document.body.classList.add("modal-open")
            }, e._resetScrollbar = function() {
                Y.find(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top").forEach(function(e) {
                    var t = U.getDataAttribute(e, "padding-right");
                    void 0 !== t && (U.removeDataAttribute(e, "padding-right"), e.style.paddingRight = t)
                }), Y.find(".sticky-top").forEach(function(e) {
                    var t = U.getDataAttribute(e, "margin-right");
                    void 0 !== t && (U.removeDataAttribute(e, "margin-right"), e.style.marginRight = t)
                });
                var e = U.getDataAttribute(document.body, "padding-right");
                void 0 === e ? document.body.style.paddingRight = "" : (U.removeDataAttribute(document.body, "padding-right"), document.body.style.paddingRight = e)
                ...
                return this.each(function() {
                    var e = S(this, "bs.modal"),
                        t = a({}, fe, U.getDataAttributes(this), "object" == typeof i && i ? i : {});
    ...
    B.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function(e) {
        var t = this,
            i = h(this);
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault(), B.one(i, "show.bs.modal", function(e) {
            e.defaultPrevented || B.one(i, "hidden.bs.modal", function() {
                b(t) && t.focus()
            })
        });
        var n = S(i, "bs.modal");
        if (!n) {
            var s = a({}, U.getDataAttributes(i), U.getDataAttributes(this));
            n = new ge(i, s)
        }
        n.show(this)
    }), e(function() {
        ...
        if (e) {
            var t = e.fn.modal;
            e.fn.modal = ge.jQueryInterface, e.fn.modal.Constructor = ge, e.fn.modal.noConflict = function() {
                return e.fn.modal = t, ge.jQueryInterface
            }
        }
    });
    var ve = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]),
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), l = Object.keys(a), d = (i = []).concat.apply(i, n.body.querySelectorAll("*")), s = function(e, t) {
                ...
                o.forEach(function(e) {
                    (function(e, t) {
                        ...
                        if (t.includes(i)) return !ve.has(i) || Boolean(e.nodeValue.match(ye) || e.nodeValue.match(be));
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        i || (i = new this.constructor(e.delegateTarget, this._getDelegateConfig()), T(e.delegateTarget, t, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                    } else {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    T(s, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || l.appendChild(s), B.trigger(this._element, this.constructor.Event.INSERTED), this._popper = f.createPopper(this._element, s, this._getPopperConfig(a)), s.classList.add("show");
                    ...
                    if (this.tip.classList.contains("fade")) {
                        var p = g(this.tip);
                        B.one(this.tip, "transitionend", h), v(this.tip, p)
                    } else h()
                }
            }, e.hide = function() {
                var e = this;
                ...
                if (null !== e) return "object" == typeof t && p(t) ? (t.jquery && (t = t[0]), void(this.config.html ? t.parentNode !== e && (e.innerHTML = "", e.appendChild(t)) : e.textContent = t.textContent)) : void(this.config.html ? (this.config.sanitize && (t = _e(t, this.config.allowList, this.config.sanitizeFn)), e.innerHTML = t) : e.textContent = t)
            }, e.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach(function(e) {
                    if ("click" === e) B.on(n._element, n.constructor.Event.CLICK, n.config.selector, function(e) {
                        return n.toggle(e)
                    });
                    else if ("manual" !== e) {
                        ...
                        B.on(n._element, t, n.config.selector, function(e) {
                            return n._enter(e)
                        }), B.on(n._element, i, n.config.selector, function(e) {
                            return n._leave(e)
                        })
                    }
                }), this._hideModalHandler = function() {
                    n._element && n.hide()
                }, B.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler), this.config.selector ? this.config = a({}, this.config, {
                    trigger: "manual",
                    selector: ""
                }) : this._fixTitle()
                ...
                var i = this.constructor.DATA_KEY;
                (t = t || S(e.delegateTarget, i)) || (t = new this.constructor(e.delegateTarget, this._getDelegateConfig()), T(e.delegateTarget, i, t)), e && (t._activeTrigger["focusout" === e.type ? "focus" : "hover"] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                ...
                return Object.keys(t).forEach(function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), y(we, e, this.constructor.DefaultType), e.sanitize && (e.template = _e(e.template, e.allowList, e.sanitizeFn)), e
    ...
    e(function() {
        ...
        if (e) {
            var t = e.fn[we];
            e.fn[we] = Pe.jQueryInterface, e.fn[we].Constructor = Pe, e.fn[we].noConflict = function() {
                return e.fn[we] = t, Pe.jQueryInterface
            }
        }
    });
    var Ee = "popover",
        Ae = new RegExp("(^|\\s)bs-popover\\S+", "g"),
        Oe = a({}, Pe.Default, {
            placement: "right",
            trigger: "click",
            content: "",
        ...
        Le = function(e) {
            ...
            return t.isWithContent = function() {
                ...
                return this.each(function() {
                    var e = S(this, "bs.popover"),
                        t = "object" == typeof i ? i : null;
                    if ((e || !/dispose|hide/.test(i)) && (e || (e = new n(this, t), T(this, "bs.popover", e)), "string" == typeof i)) {
                        if (void 0 === e[i]) throw new TypeError('No method named "' + i + '"');
                        e[i]()
                    }
                })
    ...
    e(function() {
        ...
        if (e) {
            var t = e.fn[Ee];
            e.fn[Ee] = Le.jQueryInterface, e.fn[Ee].Constructor = Le, e.fn[Ee].noConflict = function() {
                return e.fn[Ee] = t, Le.jQueryInterface
            }
        }
    });
    var De = "scrollspy",
        ...
        Re = function(n) {
            function i(e, t) {
                var i;
                return (i = n.call(this, e) || this)._scrollElement = "BODY" === e.tagName ? window : e, i._config = i._getConfig(t), i._selector = i._config.target + " .nav-link, " + i._config.target + " .list-group-item, " + i._config.target + " .dropdown-item", i._offsets = [], i._targets = [], i._activeTarget = null, i._scrollHeight = 0, B.on(i._scrollElement, "scroll.bs.scrollspy", function(e) {
                    return i._process(e)
            ...
            return e.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), Y.find(this._selector).map(function(e) {
                    var t = u(e),
                        i = t ? Y.findOne(t) : null;
                    if (i) {
                        var n = i.getBoundingClientRect();
                        if (n.width || n.height) return [U[s](i).top + o, t]
                    }
                    return null
                }).filter(function(e) {
                    return e
                ...
                n.prototype.dispose.call(this), B.off(this._scrollElement, ".bs.scrollspy"), this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e._getConfig = function(e) {
                if ("string" != typeof(e = a({}, Me, "object" == typeof e && e ? e : {})).target && p(e.target)) {
                    var t = e.target.id;
                    t || (t = m(De), e.target.id = t), e.target = "#" + t
                }
                return y(De, e, $e), e
    ...
    B.on(window, "load.bs.scrollspy.data-api", function() {
        Y.find('[data-bs-spy="scroll"]').forEach(function(e) {
            return new Re(e, U.getDataAttributes(e))
        })
    }), e(function() {
        var e = x();
        if (e) {
            var t = e.fn[De];
            e.fn[De] = Re.jQueryInterface, e.fn[De].Constructor = Re, e.fn[De].noConflict = function() {
                return e.fn[De] = t, Re.jQueryInterface
            }
        }
    });
    var Be = function(e) {
        ...
        return t.show = function() {
            ...
            if (s && o) {
                var a = g(s);
                s.classList.remove("show"), B.one(s, "transitionend", r), v(s, a)
            } else r()
            ...
            e.classList.add("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), w(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && e.parentNode.classList.contains("dropdown-menu") && (e.closest(".dropdown") && Y.find(".dropdown-toggle").forEach(function(e) {
                return e.classList.add("active")
            }), e.setAttribute("aria-expanded", !0)), i && i()
        }, i.jQueryInterface = function(t) {
            return this.each(function() {
                var e = S(this, "bs.tab") || new i(this);
                if ("string" == typeof t) {
                    if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                    e[t]()
                }
    ...
    B.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', function(e) {
        e.preventDefault(), (S(this, "bs.tab") || new Be(this)).show()
    }), e(function() {
        var e = x();
        if (e) {
            var t = e.fn.tab;
            e.fn.tab = Be.jQueryInterface, e.fn.tab.Constructor = Be, e.fn.tab.noConflict = function() {
                return e.fn.tab = t, Be.jQueryInterface
            }
        }
    });
    var qe = {
            ...
            return e.show = function() {
                ...
                if (!B.trigger(this._element, "show.bs.toast").defaultPrevented) {
                    ...
                    if (this._element.classList.remove("hide"), w(this._element), this._element.classList.add("showing"), this._config.animation) {
                        ...
                        B.one(this._element, "transitionend", t), v(this._element, i)
                    } else t()
                }
            }, e.hide = function() {
                var e = this;
                ...
                this._clearTimeout(), this._element.classList.contains("show") && this._element.classList.remove("show"), B.off(this._element, "click.dismiss.bs.toast"), n.prototype.dispose.call(this), this._config = null
            }, e._getConfig = function(e) {
                return e = a({}, Fe, U.getDataAttributes(this._element), "object" == typeof e && e ? e : {}), y("toast", e, this.constructor.DefaultType), e
            }, e._setListeners = function() {
                var e = this;
    ...
    return e(function() {
        ...
        if (e) {
            var t = e.fn.toast;
            e.fn.toast = He.jQueryInterface, e.fn.toast.Constructor = He, e.fn.toast.noConflict = function() {
                return e.fn.toast = t, He.jQueryInterface
            }
        }
    }), {
        Alert: H,
...
function(e, t) {
    ...
    var _, i = "undefined" == typeof console ? function() {} : function(e) {
            console.error(e)
        },
    ...
    return function n(e) {
        if (function() {
                if (!k) {
                    ...
                    t.appendChild(e);
                    var i = b(e);
                    _ = 200 == Math.round(y(i.width)), n.isBoxSizeOuter = _, t.removeChild(e)
                }
            ...
            for (var s = i.isBorderBox = "border-box" == t.boxSizing, o = 0; o < x; o++) {
                var r = w[o],
                    a = t[r],
                    l = parseFloat(a);
                i[r] = isNaN(l) ? 0 : l
...
function(s, o) {
    ...
    o.extend(h, t.prototype), h.option = function(e) {
        ...
        var s = this.options.stagger;
        return null == s ? void(this.stagger = 0) : (this.stagger = function(e) {
...
function(e) {
    ...
    e.prototype = {
        ...
        open: function(e) {
            ...
            if (!u.isOpen) {
                ...
                w("BeforeOpen"), u.st.showCloseBtn && (u.st.closeBtnInside ? (b(f, function(e, t, i, n) {
            ...
            getInline: function(e, t) {
                if (j(), e.src) {
                    ...
                    if (n.length) {
                        ...
                        s && s.tagName && (T || (k = i.hiddenClass, T = _(k), k = "mfp-" + k), S = n.after(T).detach().removeClass(k)), u.updateStatus("ready")
    ...
    c.magnificPopup.registerModule(E, {
        ...
        proto: {
            initAjax: function() {
                u.types.push(E), P = u.st.ajax.cursor, b(l + "." + E, O), b("BeforeChange." + E, O)
            },
            getAjax: function(s) {
                P && c(document.body).addClass(P), u.updateStatus("loading");
                var e = c.extend({
                    url: s.src,
                    success: function(e, t, i) {
                        ...
                        w("ParseAjax", n), u.appendContent(c(n.data), E), s.finished = !0, A(), u._setFocus(), setTimeout(function() {
                            u.wrap.addClass(v)
    ...
    c.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var e = u.st.image,
                    t = ".image";
                u.types.push("image"), b(m + t, function() {
                ...
                }), b("Resize" + t, u.resizeImage), u.isLowIE && b("AfterChange", u.resizeImage)
            },
    ...
    c.magnificPopup.registerModule(L, {
        ...
        proto: {
            initIframe: function() {
                u.types.push(L), b("BeforeChange", function(e, t, i) {
                    t !== i && (t === L ? D() : i === L && D(!0))
                }), b(l + "." + L, function() {
                    D()
                })
    ...
    c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var o = u.st.gallery,
                    e = ".mfp-gallery";
                return u.direction = !0, !(!o || !o.enabled) && (p += " mfp-gallery", b(m + e, function() {
                    ...
                    t.text && (t.text = $(t.text, u.currItem.index, u.items.length))
                }), b(f + e, function(e, t, i, n) {
                    var s = u.items.length;
                    i.counter = 1 < s ? $(o.tCounter, n.index, s) : ""
        ...
        proto: {
            initRetina: function() {
                if (1 < window.devicePixelRatio) {
                    var i = u.st.retina,
                        n = i.ratio;
                    1 < (n = isNaN(n) ? n() : n) && (b("ImageHasSize." + R, function(e, t) {
                        t.img.css({
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        function b(e, t, i, n, s) {
            var o, r, a, l, d, c, u, h, p, f, m, g, v, y = e.length - 1,
                b = 0,
                _ = e[0].a;
            for (o = 0; o < y; o++) r = (d = e[b]).a, a = d.d, l = e[b + 1].d, h = s ? (m = w[o], v = ((g = x[o]) + m) * t * .25 / (n ? .5 : k[o] || .5), a - ((c = a - (a - r) * (n ? .5 * t : 0 !== m ? v / m : 0)) + (((u = a + (l - a) * (n ? .5 * t : 0 !== g ? v / g : 0)) - c) * (3 * m / (m + g) + .5) / 4 || 0))) : a - ((c = a - (a - r) * t * .5) + (u = a + (l - a) * t * .5)) / 2, c += h, u += h, d.c = p = c, d.b = 0 !== o ? _ : _ = d.a + .6 * (d.c - d.a), d.da = a - r, d.ca = p - r, d.ba = _ - r, i ? (f = S(r, _, p, a), e.splice(b, 1, f[0], f[1], f[2], f[3]), b += 4) : b++, _ = u;
            (d = e[b]).b = _, d.c = _ + .4 * (d.d - _), d.da = d.d - d.a, d.ca = d.c - d.a, d.ba = _ - d.a, i && (f = S(d.a, _, d.c, d.d), e.splice(b, 1, f[0], f[1], f[2], f[3]))
        }
        ...
        function _(e, t, i, n) {
            ...
            if ((s = e.length - 2) < 0) return c[0] = new y(e[0][t], 0, 0, e[0][t]), c;
            for (o = 0; o < s; o++) r = e[o][t], a = e[o + 1][t], c[o] = new y(r, 0, 0, a), i && (l = e[o + 2][t], w[o] = (w[o] || 0) + (a - r) * (a - r), x[o] = (x[o] || 0) + (l - a) * (l - a));
            return c[o] = new y(e[o][t], 0, 0, e[o + 1][t]), c
        }
        ...
        function p(e, t, i, n, s, o) {
            ...
            for (w.length = x.length = k.length = 0, r = m.length; - 1 < --r;) a = m[r], v[a] = -1 !== s.indexOf("," + a + ","), f[a] = _(e, a, v[a], o);
            ...
            for (r = m.length, d = i ? 4 : 1; - 1 < --r;) b(l = f[a = m[r]], t, i, n, v[a]), h && (l.splice(0, d), l.splice(l.length - d, d));
            return f
        }
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(n, c, b) {
            ...
            function v(e) {
                ...
                return function(e, t, i) {
                    ...
                    if (!p) {
                        ...
                        for (p = y[h] = [], n = b ? Math.min(u, h) * w - .5 : g % u, s = b ? h * w / u - .5 : g / u | 0, c = 1 / (d = 0), l = 0; l < h; l++) o = l % u - n, r = s - (l / u | 0), p[l] = a = _ ? Math.abs("y" === _ ? r : o) : Math.sqrt(o * o + r * r), d < a && (d = a), a < c && (c = a);
                        p.max = d - c, p.min = c, p.v = h = f.amount || f.each * (h < u ? h - 1 : _ ? "y" === _ ? h / u : u : Math.max(u, h / u)) || 0, p.b = h < 0 ? v - h : v
                    }
                    return h = (p[e] - p.min) / p.max, p.b + (m ? m.getRatio(h) : h) * p.v
                }
            }
            var y = function(e, t, i) {
                    b.call(this, e, t, i), this._cycle = 0, this._yoyo = !0 === this.vars.yoyo || !!this.vars.yoyoEase, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._repeat && this._uncache(!0), this.render = y.prototype.render
                },
                _ = 1e-8,
                w = b._internals,
                x = w.isSelector,
                ...
                T = [];
            y.version = "2.1.3", e.constructor = y, e.kill()._gc = !1, y.killTweensOf = y.killDelayedCallsTo = b.killTweensOf, y.getTweensOf = b.getTweensOf, y.lagSmoothing = b.lagSmoothing, y.ticker = b.ticker, y.render = b.render, y.distribute = v, e.invalidate = function() {
                ...
                if (n._initted || o)
                    ...
                    else if (n._gc && n._enabled(!0, !1), n._notifyPluginsOfEnabled && n._firstPT && b._onPluginEvent("_onDisable", n), .998 < n._time / n._duration) {
                    var r = n._totalTime;
                ...
                if (p - _ <= e && 0 <= e ? (h._totalTime = p, h._cycle = h._repeat, h._yoyo && 0 != (1 & h._cycle) ? (h._time = 0, h.ratio = h._ease._calcEnd ? h._ease.getRatio(0) : 0) : (h._time = v, h.ratio = h._ease._calcEnd ? h._ease.getRatio(1) : 1), h._reversed || (n = !0, s = "onComplete", i = i || h._timeline.autoRemoveChildren), 0 !== v || !h._initted && h.vars.lazy && !i || (h._startTime === h._timeline._duration && (e = 0), (y < 0 || e <= 0 && -_ <= e || y === _ && "isPause" !== h.data) && y !== e && (i = !0, _ < y && (s = "onReverseComplete")), h._rawPrevTime = c = !t || e || y === e ? e : _)) : e < _ ? (h._totalTime = h._time = h._cycle = 0, h.ratio = h._ease._calcEnd ? h._ease.getRatio(0) : 0, (0 !== m || 0 === v && 0 < y) && (s = "onReverseComplete", n = h._reversed), -_ < e ? e = 0 : e < 0 && (h._active = !1, 0 !== v || !h._initted && h.vars.lazy && !i || (0 <= y && (i = !0), h._rawPrevTime = c = !t || e || y === e ? e : _)), h._initted || (i = !0)) : (h._totalTime = h._time = e, 0 !== h._repeat && (r = v + h._repeatDelay, h._cycle = h._totalTime / r >> 0, 0 !== h._cycle && h._cycle === h._totalTime / r && m <= e && h._cycle--, h._time = h._totalTime - h._cycle * r, h._yoyo && 0 != (1 & h._cycle) && (h._time = v - h._time, (u = h._yoyoEase || h.vars.yoyoEase) && (h._yoyoEase || (!0 !== u || h._initted ? h._yoyoEase = u = !0 === u ? h._ease : u instanceof Ease ? u : Ease.map[u] : (u = h.vars.ease, h._yoyoEase = u = u ? u instanceof Ease ? u : "function" == typeof u ? new Ease(u, h.vars.easeParams) : Ease.map[u] || b.defaultEase : b.defaultEase)), h.ratio = u ? 1 - u.getRatio((v - h._time) / v) : 0)), h._time > v ? h._time = v : h._time < 0 && (h._time = 0)), h._easeType && !u ? (a = h._time / v, (1 === (l = h._easeType) || 3 === l && .5 <= a) && (a = 1 - a), 3 === l && (a *= 2), 1 === (d = h._easePower) ? a *= a : 2 === d ? a *= a * a : 3 === d ? a *= a * a * a : 4 === d && (a *= a * a * a * a), h.ratio = 1 === l ? 1 - a : 2 === l ? a : h._time / v < .5 ? a / 2 : 1 - a / 2) : u || (h.ratio = h._ease.getRatio(h._time / v))), f !== h._time || i || g !== h._cycle) {
                    ...
                    h._onUpdate && (e < 0 && h._startAt && h._startTime && h._startAt.render(e, !0, i), t || h._totalTime === m && !s || h._callback("onUpdate")), h._cycle !== g && (t || h._gc || h.vars.onRepeat && h._callback("onRepeat")), !s || h._gc && !i || (e < 0 && h._startAt && !h._onUpdate && h._startTime && h._startAt.render(e, !0, i), n && (h._timeline.autoRemoveChildren && h._enabled(!1, !1), h._active = !1), !t && h.vars[s] && h._callback(s), 0 === v && h._rawPrevTime === _ && c !== _ && (h._rawPrevTime = 0))
            ...
            }, y.staggerTo = y.allTo = function(e, t, i, n, s, o, r) {
                var a, l, d, c, u = [],
                    h = v(i.stagger || n),
                    p = i.cycle,
                    f = (i.startAt || T).cycle;
                for (k(e) || ("string" == typeof e && (e = b.selector(e) || e), x(e) && (e = m(e))), a = (e = e || []).length - 1, d = 0; d <= a; d++) {
                ...
                return u
            }, y.staggerFrom = y.allFrom = function(e, t, i, n, s, o, r) {
                return i.runBackwards = !0, i.immediateRender = 0 != i.immediateRender, y.staggerTo(e, t, i, n, s, o, r)
            }, y.staggerFromTo = y.allFromTo = function(e, t, i, n, s, o, r, a) {
                return n.startAt = i, n.immediateRender = 0 != n.immediateRender && 0 != i.immediateRender, y.staggerTo(e, t, n, s, o, r, a)
            }, y.delayedCall = function(e, t, i, n, s) {
                return new y(t, 0, {
                    delay: e,
                    onComplete: t,
                    onCompleteParams: i,
            ...
            var o = function(e, t) {
                    for (var i = [], n = 0, s = e._first; s;) s instanceof b ? i[n++] = s : (t && (i[n++] = s), n = (i = i.concat(o(s, t))).length), s = s._next;
                    return i
                },
                u = y.getAllTweens = function(e) {
            ...
            return y.killAll = function(e, t, i, n) {
                ...
                if (null != e) {
                    ...
                    if ("string" == typeof e && (e = b.selector(e) || e), x(e) && (e = m(e)), k(e))
                ...
                var t = n._rootTimeline,
                    i = b.ticker.time;
                return arguments.length ? (e = e || _, t._startTime = i - (i - t._startTime) * t._timeScale / e, t = n._rootFramesTimeline, i = b.ticker.frame, t._startTime = i - (i - t._startTime) * t._timeScale / e, t._timeScale = n._rootTimeline._timeScale = e, e) : t._timeScale
            ...
            var b = 1e-8,
                ...
                i = m.prototype = new h;
            return m.version = "2.1.3", m.distribute = y, i.constructor = m, i.kill()._gc = i._forcingPlayhead = i._hasPause = !1, i.to = function(e, t, i, n) {
                ...
                var l, d, c = new m({
                    ...
                    h = i.startAt,
                    p = i.cycle;
                for ("string" == typeof e && (e = f.selector(e) || e), _(e = e || []) && (e = function(e) {
                        var t, i = [],
                            n = e.length;
                        for (t = 0; t !== n; i.push(e[t++]));
                        return i
                ...
                if (p - b <= e && 0 <= e) u._totalTime = u._time = p, u._reversed || u._hasPausedChild() || (s = !0, r = "onComplete", a = !!u._timeline.autoRemoveChildren, 0 === u._duration && (e <= 0 && -b <= e || u._rawPrevTime < 0 || u._rawPrevTime === b) && u._rawPrevTime !== e && u._first && (a = !0, u._rawPrevTime > b && (r = "onReverseComplete"))), u._rawPrevTime = u._duration || !t || e || u._rawPrevTime === e ? e : b, e = p + 1e-4;
                else if (e < b)
                    if (u._totalTime = u._time = 0, -b < e && (e = 0), (0 !== h || 0 === u._duration && u._rawPrevTime !== b && (0 < u._rawPrevTime || e < 0 && 0 <= u._rawPrevTime)) && (r = "onReverseComplete", s = u._reversed), e < 0) u._active = !1, u._timeline.autoRemoveChildren && u._reversed ? (a = s = !0, r = "onReverseComplete") : 0 <= u._rawPrevTime && u._first && (a = !0), u._rawPrevTime = e;
                    else {
                        if (u._rawPrevTime = u._duration || !t || e || u._rawPrevTime === e ? e : b, 0 === e && s)
            ...
            return s.constructor = i, s.kill()._gc = !1, i.version = "2.1.3", s.invalidate = function() {
                ...
                var n, s, o, r, a, l, d, c, u, h = this,
                    ...
                    _ = h._paused,
                    w = h._cycle;
                if (p !== h._time && (e += h._time - p), f - P <= e && 0 <= e) h._locked || (h._totalTime = f, h._cycle = h._repeat), h._reversed || h._hasPausedChild() || (s = !0, r = "onComplete", a = !!h._timeline.autoRemoveChildren, 0 === h._duration && (e <= 0 && -P <= e || b < 0 || b === P) && b !== e && h._first && (a = !0, P < b && (r = "onReverseComplete"))), h._rawPrevTime = h._duration || !t || e || h._rawPrevTime === e ? e : P, h._yoyo && 1 & h._cycle ? h._time = e = 0 : e = (h._time = m) + 1e-4;
                else if (e < P)
                    if (h._locked || (h._totalTime = h._cycle = 0), h._time = 0, -P < e && (e = 0), (0 !== p || 0 === m && b !== P && (0 < b || e < 0 && 0 <= b) && !h._locked) && (r = "onReverseComplete", s = h._reversed), e < 0) h._active = !1, h._timeline.autoRemoveChildren && h._reversed ? (a = s = !0, r = "onReverseComplete") : 0 <= b && h._first && (a = !0), h._rawPrevTime = e;
                    else {
                        if (h._rawPrevTime = m || !t || e || h._rawPrevTime === e ? e : P, 0 === e && s)
                            for (n = h._first; n && 0 === n._startTime;) n._duration || (s = !1), n = n._next;
                        e = 0, h._initted || (a = !0)
                    }
                else 0 === m && b < 0 && (a = !0), h._time = h._rawPrevTime = e, h._locked || (h._totalTime = e, 0 !== h._repeat && (l = m + h._repeatDelay, h._cycle = h._totalTime / l >> 0, h._cycle && h._cycle === h._totalTime / l && g <= e && h._cycle--, h._time = h._totalTime - h._cycle * l, h._yoyo && 1 & h._cycle && (h._time = m - h._time), h._time > m ? e = (h._time = m) + 1e-4 : h._time < 0 ? h._time = e = 0 : e = h._time));
                ...
                if (h._cycle !== w && !h._locked) {
                    var x = h._yoyo && 0 != (1 & w),
                        ...
                        C = h._rawPrevTime,
                        j = h._time;
                    if (h._totalTime = w * m, h._cycle < w ? x = !x : h._totalTime += m, h._time = p, h._rawPrevTime = 0 === m ? b - 1e-4 : b, h._cycle = w, h._locked = !0, p = x ? 0 : m, h.render(p, t, 0 === m), t || h._gc || h.vars.onRepeat && (h._cycle = S, h._locked = !1, h._callback("onRepeat")), p !== h._time) return;
                    if (k && (h._cycle = w, h._locked = !0, p = x ? m + 1e-4 : -1e-4, h.render(p, !0, !1)), h._locked = !1, h._paused && !_) return;
                ...
                if (h._time !== p && h._first || i || a || d) {
                    if (h._initted || (h._initted = !0), h._active || !h._paused && h._totalTime !== g && 0 < e && (h._active = !0), 0 === g && h.vars.onStart && (0 === h._totalTime && h._totalDuration || t || h._callback("onStart")), p <= (c = h._time))
                        for (n = h._first; n && (o = n._next, c === h._time && (!h._paused || _));)(n._active || n._startTime <= h._time && !n._paused && !n._gc) && (d === n && (h.pause(), h._pauseTime = u), n._reversed ? n.render((n._dirty ? n.totalDuration() : n._totalDuration) - (e - n._startTime) * n._timeScale, t, i) : n.render((e - n._startTime) * n._timeScale, t, i)), n = o;
                    else
                        for (n = h._last; n && (o = n._prev, c === h._time && (!h._paused || _));) {
                    ...
                    h._onUpdate && (t || (E.length && A(), h._callback("onUpdate"))), r && (h._locked || h._gc || v !== h._startTime && y === h._timeScale || !(0 === h._time || f >= h.totalDuration()) || (s && (E.length && A(), h._timeline.autoRemoveChildren && h._enabled(!1, !1), h._active = !1), !t && h.vars[r] && h._callback(r)))
            ...
            init: function(e, t, i) {
                ...
                if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? p(l, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, a) : function(e, t, i) {
                        ...
                        for (l = v.length; - 1 < --l;) {
                            ...
                            for (c = h - m + 1, d = h = 0; d < c; d += m) n = a[d], s = a[d + 1], o = a[d + 2], r = 2 == m ? 0 : a[d + 3], a[h++] = p = 3 == m ? new y(n, s, o, r) : new y(n, (2 * s + n) / 3, (2 * s + o) / 3, o);
                            a.length = h
                        }
                        return f
            ...
            set: function(e) {
                ...
                if (this._autoRotate) {
                    var g, v, y, b, _, w, x, k = this._autoRotate;
                    for (n = k.length; - 1 < --n;) s = k[n][2], w = k[n][3] || 0, x = !0 === k[n][4] ? 1 : T, o = this._beziers[k[n][0]], g = this._beziers[k[n][1]], o && g && (o = o[t], g = g[t], v = o.a + (o.b - o.a) * r, v += ((b = o.b + (o.c - o.b) * r) - v) * r, b += (o.c + (o.d - o.c) * r - b) * r, y = g.a + (g.b - g.a) * r, y += ((_ = g.b + (g.c - g.b) * r) - y) * r, _ += (g.c + (g.d - g.c) * r - _) * r, a = m ? Math.atan2(_ - y, b - v) * x + w : this._initialRotations[n], this._mod[s] && (a = this._mod[s](a, f)), p[s] ? f[s](a) : f[s] = a)
                }
            }
            ...
            function b(e, t) {
                ...
                return ae || (o.opacity = l(e)), n = Ve(e, t, !1), o.rotation = n.rotation, o.skewX = n.skewX, o.scaleX = n.scaleX, o.scaleY = n.scaleY, o.x = n.x, o.y = n.y, He && (o.z = n.z, o.rotationX = n.rotationX, o.rotationY = n.rotationY, o.scaleZ = n.scaleZ), o.filters && delete o.filters, o
            }
            ...
            function w(e, t, i) {
                if ("svg" === (e.nodeName + "").toLowerCase()) return (i || y(e))[t] || 0;
                if (e.getCTM && Xe(e)) return e.getBBox()[t] || 0;
                var n = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight),
                    s = fe[t],
                    o = s.length;
                for (i = i || y(e); - 1 < --o;) n -= parseFloat(ue(e, "padding" + s[o], i, !0)) || 0, n -= parseFloat(ue(e, "border" + s[o] + "Width", i, !0)) || 0;
                return n
            }
            ...
            function n(e, t) {
                var i, n, s, o = e.match(be) || [],
                    r = 0,
                    a = "";
                if (!o.length) return e;
                for (i = 0; i < o.length; i++) n = o[i], r += (s = e.substr(r, e.indexOf(n, r) - r)).length + n.length, 3 === (n = ye(n, t)).length && n.push(1), a += s + (t ? "hsla(" + n[0] + "," + n[1] + "%," + n[2] + "%," + n[3] : "rgba(" + n.join(",")) + ")";
                return a + e.substr(r)
            ...
            var A, x, k, H, O, z, I, L, t, i, D = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                M = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
                $ = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi,
                ...
                ae = (t = re.indexOf("Android"), i = a("a"), k = -1 !== re.indexOf("Safari") && -1 === re.indexOf("Chrome") && (-1 === t || 3 < parseFloat(re.substr(t + 8, 2))), O = k && parseFloat(re.substr(re.indexOf("Version/") + 8, 2)) < 6, H = -1 !== re.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(re) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(re)) && (z = parseFloat(RegExp.$1)), !!i && (i.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(i.style.opacity))),
                le = "",
                de = "",
                ...
                ue = F.getStyle = function(e, t, i, n, s) {
                    var o;
                    return ae || "opacity" !== t ? (!n && e.style[t] ? o = e.style[t] : (i = i || y(e)) ? o = i[t] || i.getPropertyValue(t) || i.getPropertyValue(t.replace(h, "-$1").toLowerCase()) : e.currentStyle && (o = e.currentStyle[t]), null == s || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : s) : l(e)
                },
                he = oe.convertToPixels = function(e, t, i, n, s) {
                    ...
                    else r = y(e).lineHeight, e.style.lineHeight = i, o = parseFloat(y(e).lineHeight), e.style.lineHeight = r;
                ...
                pe = oe.calculateOffset = function(e, t, i) {
                    ...
                    var n = "left" === t ? "Left" : "Top",
                        s = ue(e, "margin" + n, i);
                    return e["offset" + n] - (he(e, t, parseFloat(s), s.replace(R, "")) || 0)
                },
                fe = {
                    width: ["Left", "Right"],
                    height: ["Top", "Bottom"]
            ...
            function _e(e, t, o, r) {
                ...
                return p ? a = t ? function(e) {
                    ...
                    if ("number" == typeof e) e += f;
                        ...
                        for (s = e.replace(K, "|").split("|"), n = 0; n < s.length; n++) s[n] = a(s[n]);
                        return s.join(",")
                    }
                    if (t = (e.match(be) || [l])[0], n = (i = e.split(t).join("").match($) || []).length, p > n--)
                    ...
                    if ("number" == typeof e) e += f;
                        ...
                        for (i = e.replace(K, "|").split("|"), n = 0; n < i.length; n++) i[n] = a(i[n]);
                        return i.join(",")
                    }
            ...
            be = new RegExp(be + ")", "gi"), F.colorStringFilter = function(e) {
                var t, i = e[0] + " " + e[1];
                be.test(i) && (t = -1 !== i.indexOf("hsl(") || -1 !== i.indexOf("hsla("), e[0] = n(e[0], t), e[1] = n(e[1], t)), be.lastIndex = 0
            ...
            var ke = (oe._setPluginRatio = function(e) {
                ...
                Se = F.parseComplex = function(e, t, i, n, s, o, r, a, l, d) {
                    i = i || o || "", "function" == typeof n && (n = n(L, I)), r = new Te(e, t, 0, 0, r, d ? 2 : 1, null, !1, a, i, n), n += "", s && be.test(n + i) && (n = [i, n], F.colorStringFilter(n), i = n[0], n = n[1]);
                    var c, u, h, p, f, m, g, v, y, b, _, w, x, k = i.split(", ").join(",").split(" "),
                        T = n.split(", ").join(",").split(" "),
                        S = k.length,
                        C = !1 !== A;
                    for (-1 === n.indexOf(",") && -1 === i.indexOf(",") || (T = -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl") ? (k = k.join(" ").replace(K, ", ").split(" "), T.join(" ").replace(K, ", ").split(" ")) : (k = k.join(" ").split(",").join(", ").split(" "), T.join(" ").split(",").join(", ").split(" ")), S = k.length), S !== T.length && (S = (k = (o || "").split(" ")).length), r.plugin = l, r.setRatio = d, c = be.lastIndex = 0; c < S; c++)
                        if (p = k[c], f = T[c] + "", (v = parseFloat(p)) || 0 === v) r.appendXtra("", v, j(f, v), f.replace(M, ""), C && -1 !== f.indexOf("px") && Math.round, !0);
                        else if (s && be.test(p)) w = ")" + ((w = f.indexOf(")") + 1) ? f.substr(w) : ""), x = -1 !== f.indexOf("hsl") && ae, b = f, p = ye(p, x), f = ye(f, x), (y = 6 < p.length + f.length) && !ae && 0 === f[3] ? (r["xs" + r.l] += r.l ? " transparent" : "transparent", r.e = r.e.split(T[c]).join("transparent")) : (ae || (y = !1), x ? r.appendXtra(b.substr(0, b.indexOf("hsl")) + (y ? "hsla(" : "hsl("), p[0], j(f[0], p[0]), ",", !1, !0).appendXtra("", p[1], j(f[1], p[1]), "%,", !1).appendXtra("", p[2], j(f[2], p[2]), y ? "%," : "%" + w, !1) : r.appendXtra(b.substr(0, b.indexOf("rgb")) + (y ? "rgba(" : "rgb("), p[0], f[0] - p[0], ",", Math.round, !0).appendXtra("", p[1], f[1] - p[1], ",", Math.round).appendXtra("", p[2], f[2] - p[2], y ? "," : w, Math.round), y && (p = p.length < 4 ? 1 : p[3], r.appendXtra("", p, (f.length < 4 ? 1 : f[3]) - p, w, !1))), be.lastIndex = 0;
                    else if (m = p.match(D)) {
                        if (!(g = f.match(M)) || g.length !== m.length) return r;
                        for (u = h = 0; u < m.length; u++) _ = m[u], b = p.indexOf(_, h), r.appendXtra(p.substr(h, b - h), Number(_), j(g[u], _), "", C && "px" === p.substr(b + _.length, 2) && Math.round, 0 === u), h = b + _.length;
                        r["xs" + r.l] += p.substr(h)
            ...
            function je(e, t) {
                t = t || {}, this.p = t.prefix && C(e) || e, g[e] = g[this.p] = this, this.format = t.formatter || _e(t.defaultValue, t.color, t.collapsible, t.multi), t.parser && (this.parse = t.parser), this.clrs = t.color, this.multi = t.multi, this.keyword = t.keyword, this.dflt = t.defaultValue, this.allowFunc = t.allowFunc, this.pr = t.priority || 0
            }
            ...
            var Pe = oe._registerComplexSpecialProp = function(e, t, i) {
                    "object" != typeof t && (t = {
                        parser: i
                    });
                    var n, s = e.split(","),
                ...
                Ee = oe._registerPluginProp = function(e) {
                    if (!g[e]) {
            ...
            function Oe(e, t, i, n, s, o) {
                var r, a, l, d, c, u, h, p, f, m, g, v, y, b, _ = e._gsTransform,
                    w = Ke(e, !0);
                _ && (y = _.xOrigin, b = _.yOrigin), (!n || (r = n.split(" ")).length < 2) && (0 === (h = e.getBBox()).x && 0 === h.y && h.width + h.height === 0 && (h = {
                    x: parseFloat(e.hasAttribute("x") ? e.getAttribute("x") : e.hasAttribute("cx") ? e.getAttribute("cx") : 0) || 0,
                    y: parseFloat(e.hasAttribute("y") ? e.getAttribute("y") : e.hasAttribute("cy") ? e.getAttribute("cy") : 0) || 0,
                    width: 0,
                    height: 0
                }), r = [(-1 !== (t = ge(t).split(" "))[0].indexOf("%") ? parseFloat(t[0]) / 100 * h.width : parseFloat(t[0])) + h.x, (-1 !== t[1].indexOf("%") ? parseFloat(t[1]) / 100 * h.height : parseFloat(t[1])) + h.y]), i.xOrigin = d = parseFloat(r[0]), i.yOrigin = c = parseFloat(r[1]), n && w !== Qe && (u = w[0], h = w[1], p = w[2], f = w[3], m = w[4], g = w[5], (v = u * f - h * p) && (a = d * (f / v) + c * (-p / v) + (p * g - f * m) / v, l = d * (-h / v) + c * (u / v) - (u * g - h * m) / v, d = i.xOrigin = r[0] = a, c = i.yOrigin = r[1] = l)), _ && (o && (i.xOffset = _.xOffset, i.yOffset = _.yOffset, _ = i), s || !1 !== s && !1 !== F.defaultSmoothOrigin ? (a = d - y, l = c - b, _.xOffset += a * w[0] + l * w[2] - a, _.yOffset += a * w[1] + l * w[3] - l) : _.xOffset = _.yOffset = 0), o || e.setAttribute("data-svg-origin", r.join(" "))
            }
            ...
            function ze(e) {
                ...
                if (h) {
                    ...
                    if (null != n.ox && (b += (p = (n.oxp ? m * n.ox * .01 : n.ox) - m / 2) - (p * a + (f = (n.oyp ? g * n.oy * .01 : n.oy) - g / 2) * l), _ += f - (p * d + f * c)), y += v ? ", Dx=" + ((p = m / 2) - (p * a + (f = g / 2) * l) + b) + ", Dy=" + (f - (p * d + f * c) + _) + ")" : ", sizingMethod='auto expand')", -1 !== t.indexOf("DXImageTransform.Microsoft.Matrix(") ? u.filter = t.replace(Q, y) : u.filter = y + " " + t, 0 !== e && 1 !== e || 1 != a || 0 !== l || 0 !== d || 1 != c || v && -1 === y.indexOf("Dx=0, Dy=0") || B.test(t) && 100 !== parseFloat(RegExp.$1) || -1 === t.indexOf(t.indexOf("Alpha")) && u.removeAttribute("filter"), !v) {
                        var w, x, k, T = z < 8 ? 1 : -1;
                        for (p = n.ieOffsetX || 0, f = n.ieOffsetY || 0, n.ieOffsetX = Math.round((m - ((a < 0 ? -a : a) * m + (l < 0 ? -l : l) * g)) / 2 + b), n.ieOffsetY = Math.round((g - ((c < 0 ? -c : c) * g + (d < 0 ? -d : d) * m)) / 2 + _), Ce = 0; Ce < 4; Ce++) k = (i = -1 !== (w = h[x = me[Ce]]).indexOf("px") ? parseFloat(w) : he(this.t, x, parseFloat(w), w.replace(R, "")) || 0) !== n[x] ? Ce < 2 ? -n.ieOffsetX : -n.ieOffsetY : Ce < 2 ? p - n.ieOffsetX : f - n.ieOffsetY, u[x] = (n[x] = Math.round(i - k * (0 === Ce || 2 === Ce ? 1 : T))) + "px"
                    }
                }
            }(e = je.prototype).parseComplex = function(e, t, i, n, s, o) {
                var r, a, l, d, c, u, h = this.keyword;
                if (this.multi && (K.test(i) || K.test(t) ? (a = t.replace(K, "|").split("|"), l = i.replace(K, "|").split("|")) : h && (a = [t], l = [i])), l) {
            ...
            var Ie, Le, De, Me, $e, Re = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                ...
                He = null !== C("perspective"),
                Ne = oe.Transform = function() {
                    this.perspective = parseFloat(F.defaultTransformPerspective) || 0, this.force3D = !(!1 === F.defaultForce3D || !He) && (F.defaultForce3D || "auto")
                },
                We = _gsScope.SVGElement,
                Ge = ie.documentElement || {},
                Ue = ($e = z || /Android/i.test(re) && !_gsScope.chrome, ie.createElementNS && Ge.appendChild && !$e && (Me = (De = Ae("rect", Le = Ae("svg", Ge), {
                    width: 100,
                    height: 50,
                    x: 100
                })).getBoundingClientRect().width, De.style[Fe] = "50% 50%", De.style[Be] = "scaleX(0.5)", $e = Me === De.getBoundingClientRect().width && !(H && He), Ge.removeChild(Le)), $e),
                Ye = function(e) {
                ...
                Qe = [1, 0, 0, 1, 0, 0],
                Ke = function(e, t) {
                    var i, n, s, o, r, a, l, d = e._gsTransform || new Ne,
                        c = e.style;
                    if (Be ? n = ue(e, qe, null, !0) : e.currentStyle && (n = (n = e.currentStyle.filter.match(X)) && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), d.x || 0, d.y || 0].join(",") : ""), i = !n || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, Be && i && !e.offsetParent && e !== Ge && (o = c.display, c.display = "block", (l = e.parentNode) && e.offsetParent || (r = 1, a = e.nextSibling, Ge.appendChild(e)), i = !(n = ue(e, qe, null, !0)) || "none" === n || "matrix(1, 0, 0, 1, 0, 0)" === n, o ? c.display = o : tt(c, "display"), r && (a ? l.insertBefore(e, a) : l ? l.appendChild(e) : Ge.removeChild(e))), (d.svg || e.getCTM && Xe(e)) && (i && -1 !== (c[Be] + "").indexOf("matrix") && (n = c[Be], i = 0), s = e.getAttribute("transform"), i && s && (n = "matrix(" + (s = e.transform.baseVal.consolidate().matrix).a + "," + s.b + "," + s.c + "," + s.d + "," + s.e + "," + s.f + ")", i = 0)), i) return Qe;
                ...
                Ve = oe.getTransform = function(e, t, i, n) {
                    if (e._gsTransform && i && !n) return e._gsTransform;
                    var s, o, r, a, l, d, c = i && e._gsTransform || new Ne,
                        u = c.scaleX < 0,
                        h = He && (parseFloat(ue(e, Fe, t, !1, "0 0 0").split(" ")[2]) || c.zOrigin) || 0,
                        p = parseFloat(F.defaultTransformPerspective) || 0;
                    if (c.svg = !(!e.getCTM || !Xe(e)), c.svg && (Oe(e, ue(e, Fe, t, !1, "50% 50%") + "", c, e.getAttribute("data-svg-origin")), Ie = F.useSVGTransformAttr || Ue), (s = Ke(e)) !== Qe) {
                        if (16 === s.length) {
                            var f, m, g, v, y, b = s[0],
                                _ = s[1],
                                w = s[2],
                                ...
                                I = s[11],
                                L = Math.atan2(S, E);
                            c.zOrigin && (A = j * (z = -c.zOrigin) - s[12], O = P * z - s[13], z = E * z + c.zOrigin - s[14]), c.rotationX = L * Z, L && (f = k * (v = Math.cos(-L)) + j * (y = Math.sin(-L)), m = T * v + P * y, g = S * v + E * y, j = k * -y + j * v, P = T * -y + P * v, E = S * -y + E * v, I = C * -y + I * v, k = f, T = m, S = g), L = Math.atan2(-w, E), c.rotationY = L * Z, L && (m = _ * (v = Math.cos(-L)) - P * (y = Math.sin(-L)), g = w * v - E * y, P = _ * y + P * v, E = w * y + E * v, I = x * y + I * v, b = f = b * v - j * y, _ = m, w = g), L = Math.atan2(_, b), c.rotation = L * Z, L && (f = b * (v = Math.cos(L)) + _ * (y = Math.sin(L)), m = k * v + T * y, g = j * v + P * y, _ = _ * v - b * y, T = T * v - k * y, P = P * v - j * y, b = f, k = m, j = g), c.rotationX && 359.9 < Math.abs(c.rotationX) + Math.abs(c.rotation) && (c.rotationX = c.rotation = 0, c.rotationY = 180 - c.rotationY), L = Math.atan2(k, T), c.scaleX = (1e5 * Math.sqrt(b * b + _ * _ + w * w) + .5 | 0) / 1e5, c.scaleY = (1e5 * Math.sqrt(T * T + S * S) + .5 | 0) / 1e5, c.scaleZ = (1e5 * Math.sqrt(j * j + P * P + E * E) + .5 | 0) / 1e5, b /= c.scaleX, k /= c.scaleY, _ /= c.scaleX, T /= c.scaleY, 2e-5 < Math.abs(L) ? (c.skewX = L * Z, k = 0, "simple" !== c.skewType && (c.scaleY *= 1 / Math.cos(L))) : c.skewX = 0, c.perspective = I ? 1 / (I < 0 ? -I : I) : 0, c.x = A, c.y = O, c.z = z, c.svg && (c.x -= c.xOrigin - (c.xOrigin * b - c.yOrigin * k), c.y -= c.yOrigin - (c.yOrigin * _ - c.xOrigin * T))
                        } else if (!He || n || !s.length || c.x !== s[4] || c.y !== s[5] || !c.rotationX && !c.rotationY) {
                            var D = 6 <= s.length,
                                M = D ? s[0] : 1,
                                $ = s[1] || 0,
                                R = s[2] || 0,
                                B = D ? s[3] : 1;
                            c.x = s[4] || 0, c.y = s[5] || 0, r = Math.sqrt(M * M + $ * $), a = Math.sqrt(B * B + R * R), l = M || $ ? Math.atan2($, M) * Z : c.rotation || 0, d = R || B ? Math.atan2(R, B) * Z + l : c.skewX || 0, c.scaleX = r, c.scaleY = a, c.rotation = l, c.skewX = d, He && (c.rotationX = c.rotationY = c.z = 0, c.perspective = p, c.scaleZ = 1), c.svg && (c.x -= c.xOrigin - (c.xOrigin * M + c.yOrigin * R), c.y -= c.yOrigin - (c.xOrigin * $ + c.yOrigin * B))
                        }
                ...
                Je = oe.set3DTransformRatio = oe.setTransformRatio = function(e) {
                    var t, i, n, s, o, r, a, l, d, c, u, h, p, f, m, g, v, y, b, _, w, x, k, T = this.data,
                        S = this.t.style,
                        C = T.rotation,
                        j = T.rotationX,
                        P = T.rotationY,
                        ...
                        R = T.skewY,
                        B = T.skewX;
                    if (R && (B += R, C += R), !((1 !== e && 0 !== e || "auto" !== $ || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && $ || L || M || P || j || 1 !== O) || Ie && D || !He) C || B || D ? (C *= J, x = B * J, k = 1e5, i = Math.cos(C) * E, o = Math.sin(C) * E, n = Math.sin(C - x) * -A, r = Math.cos(C - x) * A, x && "simple" === T.skewType && (t = Math.tan(x - R * J), n *= t = Math.sqrt(1 + t * t), r *= t, R && (t = Math.tan(R * J), i *= t = Math.sqrt(1 + t * t), o *= t)), D && (z += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset, I += T.yOrigin - (T.xOrigin * o + T.yOrigin * r) + T.yOffset, Ie && (T.xPercent || T.yPercent) && (m = this.t.getBBox(), z += .01 * T.xPercent * m.width, I += .01 * T.yPercent * m.height), z < (m = 1e-6) && -m < z && (z = 0), I < m && -m < I && (I = 0)), b = (i * k | 0) / k + "," + (o * k | 0) / k + "," + (n * k | 0) / k + "," + (r * k | 0) / k + "," + z + "," + I + ")", D && Ie ? this.t.setAttribute("transform", "matrix(" + b) : S[Be] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + b) : S[Be] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + E + ",0,0," + A + "," + z + "," + I + ")";
                    else {
                        if (H && (E < (m = 1e-4) && -m < E && (E = O = 2e-5), A < m && -m < A && (A = O = 2e-5), !M || T.z || T.rotationX || T.rotationY || (M = 0)), C || B) C *= J, g = i = Math.cos(C), v = o = Math.sin(C), B && (C -= B * J, g = Math.cos(C), v = Math.sin(C), "simple" === T.skewType && (t = Math.tan((B - R) * J), g *= t = Math.sqrt(1 + t * t), v *= t, T.skewY && (t = Math.tan(R * J), i *= t = Math.sqrt(1 + t * t), o *= t))), n = -v, r = g;
                        else {
                            if (!(P || j || 1 !== O || M || D)) return void(S[Be] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) translate3d(" : "translate3d(") + z + "px," + I + "px," + L + "px)" + (1 !== E || 1 !== A ? " scale(" + E + "," + A + ")" : ""));
                            i = r = 1, n = o = 0
                        }
                        c = 1, s = a = l = d = u = h = 0, p = M ? -1 / M : 0, f = T.zOrigin, m = 1e-6, _ = ",", w = "0", (C = P * J) && (g = Math.cos(C), u = p * (l = -(v = Math.sin(C))), s = i * v, a = o * v, p *= c = g, i *= g, o *= g), (C = j * J) && (t = n * (g = Math.cos(C)) + s * (v = Math.sin(C)), y = r * g + a * v, d = c * v, h = p * v, s = n * -v + s * g, a = r * -v + a * g, c *= g, p *= g, n = t, r = y), 1 !== O && (s *= O, a *= O, c *= O, p *= O), 1 !== A && (n *= A, r *= A, d *= A, h *= A), 1 !== E && (i *= E, o *= E, l *= E, u *= E), (f || D) && (f && (z += s * -f, I += a * -f, L += c * -f + f), D && (z += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset, I += T.yOrigin - (T.xOrigin * o + T.yOrigin * r) + T.yOffset), z < m && -m < z && (z = w), I < m && -m < I && (I = w), L < m && -m < L && (L = 0)), b = T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix3d(" : "matrix3d(", b += (i < m && -m < i ? w : i) + _ + (o < m && -m < o ? w : o) + _ + (l < m && -m < l ? w : l), b += _ + (u < m && -m < u ? w : u) + _ + (n < m && -m < n ? w : n) + _ + (r < m && -m < r ? w : r), j || P || 1 !== O ? (b += _ + (d < m && -m < d ? w : d) + _ + (h < m && -m < h ? w : h) + _ + (s < m && -m < s ? w : s), b += _ + (a < m && -m < a ? w : a) + _ + (c < m && -m < c ? w : c) + _ + (p < m && -m < p ? w : p) + _) : b += ",0,0,0,0,1,0,", b += z + _ + I + _ + L + _ + (M ? 1 + -L / M : 1) + ")", S[Be] = b
                    }
                };
            ...
            function Ze(e) {
                var t, i = this.t,
                    ...
                    s = this.s + this.c * e | 0;
                100 == s && (t = -1 === n.indexOf("atrix(") && -1 === n.indexOf("radient(") && -1 === n.indexOf("oader(") ? (i.removeAttribute("filter"), !ue(this.data, "filter")) : (i.filter = n.replace(u, ""), !0)), t || (this.xn1 && (i.filter = n = n || "alpha(opacity=" + s + ")"), -1 === n.indexOf("pacity") ? 0 == s && this.xn1 || (i.filter = n + " alpha(opacity=" + s + ")") : i.filter = n.replace(B, "opacity=" + s))
            }
            ...
            function et(e) {
                ...
                parser: function(e, t, i, n, s, o, r) {
                    ...
                    var l, d, c, u, h, p, f, m, g, v = e._gsTransform,
                        ...
                        w = {},
                        x = "transformOrigin",
                        k = Ve(e, S, !0, _.parseTransform),
                        T = _.transform && ("function" == typeof _.transform ? _.transform(L, I) : _.transform);
                    if (k.skewType = _.skewType || k.skewType || F.defaultSkewType, n._transform = k, "rotationZ" in _ && (_.rotation = _.rotationZ), T && "string" == typeof T && Be)(d = ne.style)[Be] = T, d.display = "block", d.position = "absolute", -1 !== T.indexOf("%") && (d.width = ue(e, "width"), d.height = ue(e, "height")), ie.body.appendChild(ne), l = Ve(ne, null, !1), "simple" === k.skewType && (l.scaleY *= Math.cos(l.skewX * J)), k.svg && (p = k.xOrigin, f = k.yOrigin, l.x -= k.xOffset, l.y -= k.yOffset, (_.transformOrigin || _.svgOrigin) && (T = {}, Oe(e, ge(_.transformOrigin), T, _.svgOrigin, _.smoothOrigin, !0), p = T.xOrigin, f = T.yOrigin, l.x -= T.xOffset - k.xOffset, l.y -= T.yOffset - k.yOffset), (p || f) && (m = Ke(ne, !0), l.x -= p - (p * m[0] + f * m[2]), l.y -= f - (p * m[1] + f * m[3]))), ie.body.removeChild(ne), l.perspective || (l.perspective = k.perspective), null != _.xPercent && (l.xPercent = P(_.xPercent, k.xPercent)), null != _.yPercent && (l.yPercent = P(_.yPercent, k.yPercent));
                    else if ("object" == typeof _) {
                        if (l = {
                                scaleX: P(null != _.scaleX ? _.scaleX : _.scale, k.scaleX),
                                scaleY: P(null != _.scaleY ? _.scaleY : _.scale, k.scaleY),
                                scaleZ: P(_.scaleZ, k.scaleZ),
                                x: P(_.x, k.x),
                                y: P(_.y, k.y),
                                z: P(_.z, k.z),
                                xPercent: P(_.xPercent, k.xPercent),
                                yPercent: P(_.yPercent, k.yPercent),
                                perspective: P(_.transformPerspective, k.perspective)
                            }, null != (h = _.directionalRotation))
                            if ("object" == typeof h)
                                for (d in h) _[d] = h[d];
                            else _.rotation = h;
                        "string" == typeof _.x && -1 !== _.x.indexOf("%") && (l.x = 0, l.xPercent = P(_.x, k.xPercent)), "string" == typeof _.y && -1 !== _.y.indexOf("%") && (l.y = 0, l.yPercent = P(_.y, k.yPercent)), l.rotation = E("rotation" in _ ? _.rotation : "shortRotation" in _ ? _.shortRotation + "_short" : k.rotation, k.rotation, "rotation", w), He && (l.rotationX = E("rotationX" in _ ? _.rotationX : "shortRotationX" in _ ? _.shortRotationX + "_short" : k.rotationX || 0, k.rotationX, "rotationX", w), l.rotationY = E("rotationY" in _ ? _.rotationY : "shortRotationY" in _ ? _.shortRotationY + "_short" : k.rotationY || 0, k.rotationY, "rotationY", w)), l.skewX = E(_.skewX, k.skewX), l.skewY = E(_.skewY, k.skewY)
                    }
                    for (He && null != _.force3D && (k.force3D = _.force3D, u = !0), (c = k.force3D || k.z || k.rotationX || k.rotationY || l.z || l.rotationX || l.rotationY || l.perspective) || null == _.scale || (l.scaleZ = 1); - 1 < --b;)(1e-6 < (T = l[g = Re[b]] - k[g]) || T < -1e-6 || null != _[g] || null != ee[g]) && (u = !0, s = new Te(k, g, k[g], T, s), g in w && (s.e = w[g]), s.xs0 = 0, s.plugin = o, n._overwriteProps.push(s.n));
                    return T = "function" == typeof _.transformOrigin ? _.transformOrigin(L, I) : _.transformOrigin, k.svg && (T || _.svgOrigin) && (p = k.xOffset, f = k.yOffset, Oe(e, ge(T), l, _.svgOrigin, _.smoothOrigin), s = xe(k, "xOrigin", (v ? k : l).xOrigin, l.xOrigin, s, x), s = xe(k, "yOrigin", (v ? k : l).yOrigin, l.yOrigin, s, x), p === k.xOffset && f === k.yOffset || (s = xe(k, "xOffset", v ? p : k.xOffset, k.xOffset, s, x), s = xe(k, "yOffset", v ? f : k.yOffset, k.yOffset, s, x)), T = "0px 0px"), (T || He && c && k.zOrigin) && (Be ? (u = !0, g = Fe, T || (T = (T = (ue(e, g, S, !1, "50% 50%") + "").split(" "))[0] + " " + T[1] + " " + k.zOrigin + "px"), T += "", (s = new Te(y, g, 0, 0, s, -1, x)).b = y[g], s.plugin = o, He ? (d = k.zOrigin, T = T.split(" "), k.zOrigin = (2 < T.length ? parseFloat(T[2]) : d) || 0, s.xs0 = s.e = T[0] + " " + (T[1] || "50%") + " 0px", (s = new Te(k, "zOrigin", 0, 0, s, -1, s.n)).b = d, s.xs0 = s.e = k.zOrigin) : s.xs0 = s.e = T) : ge(T + "", k)), u && (n._transformType = k.svg && Ie || !c && 3 !== this._transformType ? 2 : 3), a && (r.scale = a), s
                },
                allowFunc: !0,
                prefix: !0
            }), Pe("boxShadow", {
                ...
                parser: function(e, t, i, n, s, o) {
                    t = this.format(t);
                    var r, a, l, d, c, u, h, p, f, m, g, v, y, b, _, w, x = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                        k = e.style;
                    for (f = parseFloat(e.offsetWidth), m = parseFloat(e.offsetHeight), r = t.split(" "), a = 0; a < x.length; a++) this.p.indexOf("border") && (x[a] = C(x[a])), -1 !== (c = d = ue(e, x[a], S, !1, "0px")).indexOf(" ") && (c = (d = c.split(" "))[0], d = d[1]), u = l = r[a], h = parseFloat(c), v = c.substr((h + "").length), "" === (g = (y = "=" === u.charAt(1)) ? (p = parseInt(u.charAt(0) + "1", 10), u = u.substr(2), p *= parseFloat(u), u.substr((p + "").length - (p < 0 ? 1 : 0)) || "") : (p = parseFloat(u), u.substr((p + "").length))) && (g = T[i] || v), g !== v && (b = he(e, "borderLeft", h, v), _ = he(e, "borderTop", h, v), d = "%" === g ? (c = b / f * 100 + "%", _ / m * 100 + "%") : "em" === g ? (c = b / (w = he(e, "borderLeft", 1, "em")) + "em", _ / w + "em") : (c = b + "px", _ + "px"), y && (u = parseFloat(c) + p + g, l = parseFloat(d) + p + g)), s = Se(k, x[a], c + " " + d, u + " " + l, !1, "0px", s);
                    return s
                },
                prefix: !0,
            ...
            for (Pe("className", {
                    parser: function(e, t, i, n, s, o, r) {
                        var a, l, d, c, u, h = e.getAttribute("class") || "",
                            p = e.style.cssText;
                        if ((s = n._classNamePT = new Te(e, i, 0, 0, s, 2)).setRatio = et, s.pr = -11, f = !0, s.b = h, l = b(e, S), d = e._gsClassPT) {
                            for (c = {}, u = d.data; u;) c[u.p] = 1, u = u._next;
                            d.setRatio(1)
                        }
                        return (e._gsClassPT = s).e = "=" !== t.charAt(1) ? t : h.replace(new RegExp("(?:\\s|^)" + t.substr(2) + "(?![\\w-])"), "") + ("+" === t.charAt(0) ? " " + t.substr(2) : ""), e.setAttribute("class", s.e), a = _(e, l, b(e), r, c), e.setAttribute("class", h), s.data = a.firstMPT, e.style.cssText !== p && (e.style.cssText = p), s.xfirst = n.parse(e, a.difs, s, o)
                    }
                }), Pe("clearProps", {
                    parser: function(e, t, i, n, s) {
            ...
            function nt(e) {
                ...
                this._target = I = e, this._tween = i, this._vars = t, L = n, A = t.autoRound, f = !1, T = t.suffixMap || F.suffixMap, S = y(e), m = this._overwriteProps;
                var s, o, r, a, l, d, c, u, h, p = e.style;
                if (x && "" === p.zIndex && ("auto" !== (s = ue(e, "zIndex", S)) && "" !== s || this._addLazySet(p, "zIndex", 0)), "string" == typeof t && (a = p.cssText, s = b(e, S), p.cssText = a + ";" + t, s = _(e, s, b(e)).difs, !ae && N.test(t) && (s.opacity = parseFloat(RegExp.$1)), t = s, p.cssText = a), t.className ? this._firstPT = o = g.className.parse(e, t.className, "className", this, null, null, t) : this._firstPT = o = this.parse(e, t, null), this._transformType) {
                    for (h = 3 === this._transformType, Be ? k && (x = !0, "" === p.zIndex && ("auto" !== (c = ue(e, "zIndex", S)) && "" !== c || this._addLazySet(p, "zIndex", 0)), O && this._addLazySet(p, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (h ? "visible" : "hidden"))) : p.zoom = 1, r = o; r && r._next;) r = r._next;
                    u = new Te(e, "transform", 0, 0, null, 2), this._linkCSSP(u, null, r), u.setRatio = Be ? Je : ze, u.data = this._transform || Ve(e, S, !0), u.tween = i, u.pr = -1, m.pop()
                }
                if (f) {
                    for (; o;) {
                ...
                for (s in t) {
                    if (d = t[s], o = g[s], "function" != typeof d || o && o.allowFunc || (d = d(L, I)), o) i = o.parse(e, d, s, this, i, n, t);
                        ...
                        if ("--" === s.substr(0, 2)) {
                            this._tween._propLookup[s] = this._addTween.call(this._tween, e.style, "setProperty", y(e).getPropertyValue(s) + "", d + "", s, !1, s);
                            continue
                        }
                        l = ue(e, s, S) + "", h = "string" == typeof d, "color" === s || "fill" === s || "stroke" === s || -1 !== s.indexOf("Color") || h && W.test(d) ? (h || (d = (3 < (d = ye(d)).length ? "rgba(" : "rgb(") + d.join(",") + ")"), i = Se(f, s, l, d, !0, "transparent", i, 0, n)) : h && V.test(d) ? i = Se(f, s, l, d, !0, null, i, 0, n) : (c = (r = parseFloat(l)) || 0 === r ? l.substr((r + "").length) : "", "" !== l && "auto" !== l || (c = "width" === s || "height" === s ? (r = w(e, s, S), "px") : "left" === s || "top" === s ? (r = pe(e, s, S), "px") : (r = "opacity" !== s ? 0 : 1, "")), "" === (u = (p = h && "=" === d.charAt(1)) ? (a = parseInt(d.charAt(0) + "1", 10), d = d.substr(2), a *= parseFloat(d), d.replace(R, "")) : (a = parseFloat(d), h ? d.replace(R, "") : "")) && (u = s in T ? T[s] : c), d = a || 0 === a ? (p ? a + r : a) + u : t[s], c === u || "" === u && "lineHeight" !== s || !a && 0 !== a || !r || (r = he(e, s, r, c), "%" === u ? (r /= he(e, s, 100, "%") / 100, !0 !== t.strictUnits && (l = r + "%")) : "em" === u || "rem" === u || "vw" === u || "vh" === u ? r /= he(e, s, 1, u) : "px" !== u && (a = he(e, s, a, u), u = "px"), p && (a || 0 === a) && (d = a + r + u)), p && (a += r), !r && 0 !== r || !a && 0 !== a ? void 0 !== f[s] && (d || d + "" != "NaN" && null != d) ? (i = new Te(f, s, a || r || 0, 0, i, -1, s, !1, 0, l, d)).xs0 = "none" !== d || "display" !== s && -1 === s.indexOf("Style") ? d : l : v("invalid " + s + " tween value: " + t[s]) : (i = new Te(f, s, r, a - r, i, 0, s, !1 !== A && ("px" === u || "zIndex" === s), 0, l, d)).xs0 = u)
                    }
                ...
                this._transform = this._transform || Ve(this._target, S, !0), this._transformType = this._transform.svg && Ie || !e && 3 !== this._transformType ? 2 : 3
            ...
            var st = function(e, t, i) {
                ...
                if (e.slice)
                    ...
                    for (s = (n = e.childNodes).length; - 1 < --s;) r = (o = n[s]).type, o.style && (t.push(b(o)), i && i.push(o)), 1 !== r && 9 !== r && 11 !== r || !o.childNodes.length || st(o, t, i)
            };
    ...
    function(h, p) {
        ...
        function v() {}
        var t, i, s, y, b, o, r, u = g("com.greensock"),
            _ = 1e-8,
        ...
        (s = j.prototype).addEventListener = function(e, t, i, n, s) {
            ...
            var o, r, a = this._listeners[e],
                l = 0;
            for (this !== y || b || y.wake(), null == a && (this._listeners[e] = a = []), r = a.length; - 1 < --r;)(o = a[r]).c === t && o.s === i ? a.splice(r, 1) : 0 === l && o.pr < s && (l = r + 1);
            a.splice(l, 0, {
                c: t,
                s: i,
                up: n,
        ...
        var P = h.requestAnimationFrame,
            E = h.cancelAnimationFrame,
            A = Date.now || function() {
                return (new Date).getTime()
            },
            O = A();
        for (i = (t = ["ms", "moz", "webkit", "o"]).length; - 1 < --i && !P;) P = h[t[i] + "RequestAnimationFrame"], E = h[t[i] + "CancelAnimationFrame"] || h[t[i] + "CancelRequestAnimationFrame"];
        T("Ticker", function(e, t) {
            var s, o, r, a, l, d = this,
                ...
                p = function(e) {
                    var t, i, n = A() - O;
                    u < n && (c += n - h), O += n, d.time = (O - c) / 1e3, t = d.time - l, (!s || 0 < t || !0 === e) && (d.frame++, l += t + (a <= t ? .004 : a - t), i = !0), !0 !== e && (r = o(p)), i && d.dispatchEvent("tick")
                };
            j.call(d), d.time = d.frame = 0, d.tick = function() {
                ...
                null != r && ((i && E ? E : clearTimeout)(r), o = v, r = null, d === y && (b = !1))
            }, d.wake = function(e) {
                null !== r ? d.sleep() : e ? c += -O + (O = A()) : 10 < d.frame && (O = A() - u + 5), o = 0 === s ? v : i && P ? P : function(e) {
        ...
        y = z.ticker = new u.Ticker, (s = z.prototype)._dirty = s._gc = s._initted = s._paused = !1, s._totalTime = s._time = 0, s._rawPrevTime = -1, s._next = s._last = s._onUpdate = s._timeline = s.timeline = null, s._paused = !1;
        var I = function() {
            b && 2e3 < A() - O && ("hidden" !== (n || {}).visibilityState || !y.lagSmoothing()) && y.wake();
        ...
        I(), s.play = function(e, t) {
            ...
            return b || y.wake(), this._gc = !e, this._active = this.isActive(), !0 !== t && (e && !this.timeline ? this._timeline.add(this, this._startTime - this._delay) : !e && this.timeline && this._timeline._remove(this, !0)), !1
            ...
            return e != this._paused && n && (b || e || y.wake(), i = (t = n.rawTime()) - this._pauseTime, !e && n.smoothChildTiming && (this._startTime += i, this._uncache(!1)), this._pauseTime = e ? t : null, this._paused = e, this._active = this.isActive(), !e && 0 != i && this._initted && this.duration() && (t = n.smoothChildTiming ? this._totalTime : (t - this._startTime) / this._timeScale, this.render(t, t === this._totalTime, !0))), this._gc && !e && this._enabled(!0, !1), this
        };
        ...
        var M = T("TweenLite", function(e, t, i) {
            ...
            if (this._overwrite = a = null == a ? K[M.defaultOverwrite] : "number" == typeof a ? a >> 0 : K[a], (r || e instanceof Array || e.push && w(e)) && "number" != typeof e[0])
        ...
        function B(e, t, i, n) {
            ...
            return (p += t.substr(h)) && u.push(p), u.setRatio = $, W.test(t) && (u.end = null), u
        }
        ...
        }(s = M.prototype = new z).constructor = M, s.kill()._gc = !1, s.ratio = 0, s._firstPT = s._targets = s._overwrittenProps = s._startAt = null, s._notifyPluginsOfEnabled = s._lazy = !1, M.version = "2.1.3", M.defaultEase = s._ease = new S(null, null, 1, 1), M.defaultOverwrite = "auto", M.ticker = y, M.autoSleep = 120, M.lagSmoothing = function(e, t) {
            y.lagSmoothing(e, t)
        ...
        J._startTime = y.time, V._startTime = y.frame, J._active = V._active = !0, setTimeout(ee, 1), z._updateRoot = M.render = function() {
            var e, t, i;
            if (F.length && ee(), J.render((y.time - J._startTime) * J._timeScale, !1, !1), V.render((y.frame - V._startTime) * V._timeScale, !1, !1), F.length && ee(), y.frame >= Z) {
                for (i in Z = y.frame + (parseInt(M.autoSleep, 10) || 120), Y) {
                    for (e = (t = Y[i].tweens).length; - 1 < --e;) t[e]._gc && t.splice(e, 1);
                    0 === t.length && delete Y[i]
                }
                if ((!(i = J._first) || i._paused) && M.autoSleep && !V._first && 1 === y._listeners.tick.length) {
        ...
        var ie = function(e, t, i) {
            ...
            se = function(e, t, i) {
                ...
                return t < (o /= s) ? o - t : i && o === t || !e._initted && o - t < 2e-8 ? _ : (o += e.totalDuration() / e._timeScale / s) > t + _ ? 0 : o - t - _
            };
        s._init = function() {
            ...
            var o, r, a, l, d, c;
            if (null == e) return !1;
            for (o in H[e._gsTweenID] && ee(), this.vars.css || e.style && e !== h && e.nodeType && U.css && !1 !== this.vars.autoCSS && function(e, t) {
                    var i, n = {};
                ...
                if (c = this.vars[o], Q[o]) c && (c instanceof Array || c.push && w(c)) && -1 !== c.join("").indexOf("{self}") && (this.vars[o] = c = this._swapSelfInParams(c, this));
            ...
            return n && this._kill(n, e) ? this._initProps(e, t, i, n, s) : 1 < this._overwrite && this._firstPT && 1 < i.length && ne(e, this, t, this._overwrite, i) ? (this._kill(t, e), this._initProps(e, t, i, n, s)) : (this._firstPT && (!1 !== this.vars.lazy && this._duration || this.vars.lazy && !this._duration) && (H[e._gsTweenID] = !0), a)
        }, s.render = function(e, t, i) {
            var n, s, o, r, a = this,
                l = a._time,
                d = a._duration,
                c = a._rawPrevTime;
            if (d - _ <= e && 0 <= e) a._totalTime = a._time = d, a.ratio = a._ease._calcEnd ? a._ease.getRatio(1) : 1, a._reversed || (n = !0, s = "onComplete", i = i || a._timeline.autoRemoveChildren), 0 !== d || !a._initted && a.vars.lazy && !i || (a._startTime === a._timeline._duration && (e = 0), (c < 0 || e <= 0 && -_ <= e || c === _ && "isPause" !== a.data) && c !== e && (i = !0, _ < c && (s = "onReverseComplete")), a._rawPrevTime = r = !t || e || c === e ? e : _);
            else if (e < _) a._totalTime = a._time = 0, a.ratio = a._ease._calcEnd ? a._ease.getRatio(0) : 0, (0 !== l || 0 === d && 0 < c) && (s = "onReverseComplete", n = a._reversed), -_ < e ? e = 0 : e < 0 && (a._active = !1, 0 !== d || !a._initted && a.vars.lazy && !i || (0 <= c && (c !== _ || "isPause" !== a.data) && (i = !0), a._rawPrevTime = r = !t || e || c === e ? e : _)), (!a._initted || a._startAt && a._startAt.progress()) && (i = !0);
            ...
            if (a._time !== l || i) {
                ...
                a._onUpdate && (e < 0 && a._startAt && -1e-4 !== e && a._startAt.render(e, !0, i), t || (a._time !== l || n || i) && a._callback("onUpdate")), !s || a._gc && !i || (e < 0 && a._startAt && !a._onUpdate && -1e-4 !== e && a._startAt.render(e, !0, i), n && (a._timeline.autoRemoveChildren && a._enabled(!1, !1), a._active = !1), !t && a.vars[s] && a._callback(s), 0 === d && a._rawPrevTime === _ && r !== _ && (a._rawPrevTime = 0))
            }
            ...
            var e = this._time;
            return this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], z.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -_, this.render(e, !1, !1 !== this.vars.lazy)), this
        }, s._enabled = function(e, t) {
            if (b || y.wake(), e && this._gc) {
        ...
        if (s = oe.prototype, oe.version = "1.19.0", oe.API = 2, s._firstPT = null, s._addTween = q, s.setRatio = $, s._kill = function(e) {
    ...
    function(e) {
        ...
        (void 0 !== LS_GSAP ? LS_GSAP : window).SplitType = function(P, l, o) {
            function d(e) {
            ...
            function n(e, t) {
                return this instanceof n ? (this.isSplit = !1, this.settings = i(m, t), this.elements = function(e) {
                    ...
                    return A(e).html = A(e).html || e.innerHTML
            ...
            if (l.addEventListener && Function.prototype.bind) {
                ...
                return s(n, "defaults", {
                    ...
                    this.revert(), this.lines = [], this.words = [], this.chars = [], e !== o && (this.settings = i(this.settings, e)), E(this.elements, function(e) {
                        (function(e) {
                            var t, i, n, s, o = this.settings,
                                ...
                                f = [],
                                m = [];
                            if (n = d ? O("div") : L(), p.innerHTML = e.innerHTML.replace(/<br\s*\/?>/g, " " + a + " "), s = p.textContent.replace(/\s+/g, " ").trim().split(" ").map(function(e) {
                                    if (e === a) return n.appendChild(O("br")), null;
                                    if (u) {
                                    ...
                                    }), n.appendChild(i)) : E(t, function(e) {
                                        n.appendChild(e)
                                    }), n.appendChild(D(" ")), i
                                }, this).filter(function(e) {
                                    return e
                                }), e.innerHTML = "", e.appendChild(n), z.apply(this.words, s), z.apply(this.chars, m), h || d) {
                                var g, v, y, b, _, w, x, k, T, S, C, j = [];
                                x = A(e).nodes = e.getElementsByTagName(r), k = e.parentElement, T = e.nextElementSibling, S = P.getComputedStyle(e), C = S.textAlign, h && (b = {
                                    left: n.offsetLeft,
                                    top: n.offsetTop,
                                    width: n.offsetWidth
                                }, w = e.offsetWidth, _ = e.offsetHeight, A(e).cssWidth = e.style.width, A(e).cssHeight = e.style.height), E(x, function(e) {
                                    if (e !== n) {
                                        var t, i = e.parentElement === n;
                                        d && i && ((t = A(e).top = e.offsetTop) !== v && (v = t, j.push(g = [])), g.push(e)), h && (A(e).top = t || e.offsetTop, A(e).left = e.offsetLeft, A(e).width = e.offsetWidth, A(e).height = y = y || e.offsetHeight)
                                    }
                                }), k.removeChild(e), d && (n = L(), f = j.map(function(e) {
                                    return n.appendChild(t = O(r, {
                                        class: o.lineClass + " " + o.splitClass,
                                        style: "display: block; text-align:" + C + "; width: 100%;"
                                    })), h && (A(t).type = "line", A(t).top = A(e[0]).top, A(t).height = y), E(e, function(e) {
                                        c ? t.appendChild(e) : u ? I.call(e.children).forEach(function(e) {
                                            t.appendChild(e)
                                        }) : t.appendChild(D(e.textContent)), t.appendChild(D(" "))
                                    }), t
                                }), e.replaceChild(n, e.firstChild), z.apply(this.lines, f)), h && (e.style.width = e.style.width || w + "px", e.style.height = _ + "px", E(x, function(e) {
                                    var t = "line" === A(e).type,
                                        i = !t && "line" === A(e.parentElement).type;
                                    e.style.top = i ? 0 : A(e).top + "px", e.style.left = t ? b.left + "px" : (i ? A(e).left - b.left : A(e).left) + "px", e.style.height = A(e).height + "px", e.style.width = t ? b.width + "px" : A(e).width + "px", e.style.position = "absolute"
                                })), T ? k.insertBefore(e, T) : k.appendChild(e)
                            }
                        }).call(this, e), A(e).isSplit = !0
                    }, this), this.isSplit = !0, E(this.elements, function(e) {
                        for (var t = A(e).nodes || [], i = 0, n = t.length; i < n; i++)(o = (s = t[i]) && s[r]) && (delete s[o], delete a[o]);
                        var s, o
                    })
                }, n.prototype.revert = function() {
                    this.isSplit && (this.lines = this.words = this.chars = null), E(this.elements, function(e) {
                        A(e).isSplit && A(e).html && (e.innerHTML = A(e).html, e.style.height = A(e).cssHeight || "", e.style.width = A(e).cssWidth || "", this.isSplit = !1)
                    }, this)
                }, n
            }
        }(window, document)
